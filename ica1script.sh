...
rm -fr ${PWD}/genecount
mkdir ${PWD}/genecount
genecount=${PWD}/genecount
while read Tcopart1 Tcopart2
do
bedtools coverage -a TriTrypDB-46_TcongolenseIL3000_2019.bed -b ${PWD}/fastq/alignoutput/${Tcopart1}_sort.bam > ${genecount}/${Tcopart1}.gene.counts.txt
done < ${PWD}/fastq/sequence_file.txt
unset IFS
